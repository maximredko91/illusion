package com.illusion.app.data.download
 ...
 * - No folder picked (default): public `Downloads/Illusion` via [MediaStore.Downloads] (API 29+) or a
...
object DownloadStorage {
    const val RELATIVE_DIR = "Illusion"
     ...
     * SAF tree if the user picked one in Settings, otherwise `Downloads/Illusion` specifically
