...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Hidden entry point into the developer-only "add media" scraper - 7 taps here, then a
            // password (see DevAccessStore's KDoc for why this is a deterrent, not real security).
                ...
                modifier = Modifier
                    ...
                    .clickable(indication = null, interactionSource = remember { MutableInteractionSource() }) {
                        ...
                        if (devTapCount >= 7) {
                            devTapCount = 0
                            if (hasDevPassword()) {
                                showDevPasswordEntry = true
                            } else {
                                showDevPasswordGenerated = onGenerateDevPassword()
                            }
                        }
                    },
            ...
            showDevPasswordGenerated?.let { password ->
                AlertDialog(
                    onDismissRequest = { showDevPasswordGenerated = null; onDevAccessGranted() },
                    ...
                    confirmButton = {
                        TextButton(onClick = { showDevPasswordGenerated = null; onDevAccessGranted() }) {
